  ...
  slides: [
    {
      ...
      text: "智慧花園裡，落葉飛舞，擺滿了古老的星象儀與羊皮紙。8 歲的祈織把那些無聊的解籤書一氣之下撕得乾乾淨淨，嘟起嘴：「大人的腦袋都笨笨的，一條簡單的命運線要想好久，好幼稚喔！」",
      glowRGB: WISDOM_BLUE,
    },
    {
    ...
    },
    {
      ...
      text: "雅典娜隨手將碎紙一揮，碎紙竟在空中組合成縱橫交錯的金色光線，像一張精密的高科技沙盤。「每一個凡人的卡關，都是一場等待被解開的拼圖。智慧不是用來嘲笑愚蠢的唷，是用來幫混亂的腦袋梳理出好玩的通關路線的！」",
      glowRGB: DIVINE_FLASH,
    },
    {
