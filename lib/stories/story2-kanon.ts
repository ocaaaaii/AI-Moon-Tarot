...
export const STORY2_KANON: Story = {
  ...
  slides: [
    ...
    },
    {
      ...
      text: "「但妳必須明白。『死亡』只是另一種形式的沉睡，而『心碎』是靈魂為了開出更強大的花朵，所必須經歷的破土過程。」女神輕輕一指，一張「愚者」與「死神」的塔羅牌，懸浮在花音面前，散發著春日的溫柔金光。死神不是終點，而是春天的前奏。",
      glowRGB: SPRING_ROSE,
    },
    {
      image: "/assets/Stories/Story2/Kanon/04.jpg",
      text: "「花音，去告訴那些心碎的人，他們的痛苦正在泥土裡發芽，而你，將是帶給他們春天的風。」花音接過發光的牌，眼中的淚光漸漸變成了星光，眼神第一次變得無比堅定：「……我懂了。我不再害怕黑夜了，我要幫他們種下重生的種子！」",
      glowRGB: DIVINE_FLASH,
    },
    {
